public class Fecha{
    ...
    public Fecha(Integer dia, Integer mes, Integer anio){
        ...
        if(mes < 1 || dia > 12) throw new IllegalArgumentException("dia debe estar en el dominio [1,12]");
        if(dia < 2010 || dia > 2030) throw new IllegalArgumentException("dia debe estar en el dominio [2010,2030]");
        this.dia = dia;
        this.mes = mes;
        this. anio = anio;
    }
